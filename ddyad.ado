...
quietly drop if ccode2==255  & ccode1==260  & year==1990      
quietly drop if ccode2==255  & ccode1==265  & year==1990     
quietly drop if ccode2==678  & ccode1==679  & year==1990   
quietly drop if ccode2==679  & ccode1==680  & year==1990 
